...
export const cardpool: Card[] = [
    ...
    { id: "12", name: "Princess Portal", iml: "src/assets/decks/techno_princess/qp_princess_portal.png", atk: -1, def: -1, cost: 4, special: "instantinvoke 1", description: "Instant AI Princess" },
