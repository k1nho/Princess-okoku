    ...
    return (
        <>
            <div className="flex flex-col space-y-10 justify-center items-center min-h-screen bg-stone-800 relative">
                ...
                <motion.div className="absolute bottom-0 left-10" animate={{ x: 100, y: -80, rotate: 25 }} transition={{ duration: 1 }}><StaticCard /></motion.div>
                <div>
                ...
                <div className="flex flex-col items-center justify-center space-y-4">
                    <div className="flex space-x-2">
                        <button
                            className=" flex items-center space-x-2 px-8 py-6 rounded-full bg-pink-400 hover:bg-pink-500 transition ease-in-out duration-700 text-gray-100"
                        ...
                        <button className=" flex items-center space-x-2 px-8 py-6 rounded-full bg-amber-400 hover:bg-amber-500 transition ease-in-out duration-700 text-gray-100">
                            <span className="text-2xl">
                                <GiInfo />
                            </span>
