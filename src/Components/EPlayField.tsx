...
export const EplayField: React.FC = () => {
    const [playedCards, lp, energy] = usePlayerStore((state) => [state.enemyBattleInfo.playedCards, state.enemyBattleInfo.lp, state.enemyBattleInfo.energy])
