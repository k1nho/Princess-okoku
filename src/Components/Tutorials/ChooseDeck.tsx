    ...
    <div className="flex flex-col">
      ...
      <div className="flex  flex-wrap justify-evenly p-2">
        ...
        <div
          ...
          style={{
            border:
              selectedDeckId === 1 ? "5px solid #FFD700" : "5px solid #ea580c ",
          }}
        ...
        <div
          ...
          style={{
            border:
              selectedDeckId === 3 ? "5px solid #FFD700" : "5px solid #38bdf8",
          }}
        ...
        >
          ...
          <div className="flex flex-wrap font-semibold text-lg text-gray-100 text-center">
            <p>
              ...
              reduce cost mechanic, command these felines through the lands of
              Althreisha
            </p>
          </div>
        </div>
